...
string Translate(string Text, string &in SrcLang, string &in DstLang)
{
	...
	// mod by om
	// 比较失望：bing 的翻译 API 不如浏览器里翻译的好，反正已经建立好了。代码保持下吧。
	string url = "https://api.cognitive.microsofttranslator.com/translate?api-version=3.0&to=" + DstLang;
	if (SrcLang != "auto")
	{
		url += "&from=" + SrcLang;
	}
	...
	// SendHeader += "Ocp-Apim-Subscription-Region:eastasia\r\n";
